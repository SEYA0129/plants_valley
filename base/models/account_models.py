...
from base.models import create_id # item_models.pyから
...
class Profile(models.Model):
    ...
    name = models.CharField(default='', blank=True, max_length=50) #送付先に必要な名前。
...
# OneToOneFieldを同時に作成　Userが作成されると同時にProfileも作成される
@receiver(post_save, sender=User) #関数の直前に実行
